...
public class SightreadingView extends AppCompatActivity {
    static final String LABLE="foo";
    MelodyGenerator melodyGenerator=new MelodyGenerator();
    public static final AudioHandler h = new AudioHandler();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //final AudioHandler h = new AudioHandler();
        //button_start.OnClickListener
        button_stop.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View v){
                //button_stop.setText("bleh");
                generateMelody();
                //h.startRecording();
            }
        });
        final Button button_playback = (Button) findViewById(R.id.button_playback);
        //button_start.OnClickListener
        button_playback.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v){
                //button_stop.setText("bleh");
                //h.stopRecording();
                //h.startPlaybackOfRecordedVoice();
            }
        });
    }
